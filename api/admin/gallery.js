// =========================
// API: /api/admin/gallery (gabungan galeri + foto profil sosmed + tulis Berita)
...
// api/admin/siswa.js. Fitur foto sosmed dan Berita & Pengumuman SENGAJA
// ditumpangkan di file & function ini (bukan file /api baru) supaya
// jumlah total Serverless Functions tidak bertambah (tetap 11).
// =========================

const crypto = require("crypto");
const { getLoggedInAdmin, getLoggedInAdminInfo, isSuperAdminUsername } = require("../../lib/auth");
